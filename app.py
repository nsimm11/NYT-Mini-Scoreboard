...
st.markdown("#### Rules")
st.markdown("<div style='text-align:left;'>Tour de France Style - Best accumulated time at the end of the month wins!</div>", unsafe_allow_html=True)
st.markdown("<div style='text-align:left;'>If you miss a day, you get the worst time!</div>", unsafe_allow_html=True)
st.markdown("<div style='text-align:left;'>Upload your Leaderboard Screenshots below to add times to the leaderboard</div>", unsafe_allow_html=True)
